...
INSERT INTO `rpos_admin` (`admin_id`, `admin_name`, `admin_email`, `admin_password`) VALUES ('2', 'Disha', 'disha@gmail.com', '10470c3b4b1fed12c3baac014be15fac67c6e815');
-- --------------------------------------------------------
...
--
-- Table structure for `rpos_table`
--
...
--
-- Indexes for table `rpos_table`
--
ALTER TABLE `rpos_table`
